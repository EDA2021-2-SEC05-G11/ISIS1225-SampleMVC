...
from controller import loadBooksTags
import config as cf
import sys
import controller
...
def printMenu():
    ...
    print("2- Cargar Tags")
    print("3- Cargar identificadores de los Libros y Tags")
    print("0- Salir")
...
while True:
    ...
    if int(inputs[0]) == 1:
        ...
        print("Cargarndo identificadores de tags y libros....")
        bookstags = loadBookTags()
        print('Total de tags cargados: ' + str(lt.size(bookstags)))
